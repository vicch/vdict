...
class WordHelper
{
    ...
    public static function outWordLeft($word)
    {
        ...
        $out .= '</div>';
        $out .= '<div class="w-btn-wrap"><button class="btn-add-sns btn btn-default btn-sm" data-toggle="modal" data-target="#sns-multi-modal"><span class="glyphicon glyphicon-plus"></span></button></div></div></div>';
        return $out;
    }
    ...
    public static function outWordRight($word)
    {
        ...
        $out .= '<button class="btn-edit-conn btn btn-default btn-sm" data-toggle="modal" data-target="#edit-conn-modal" f-sns="' . $word['conn_data']['f_sense'] . '" conn-type="' . $word['conn_data']['type'] . '" t-sns="' . $word['conn_data']['t_sense'] . '" t-snss="' . implode(',', array_keys($word['snss'])) . '"><span class="glyphicon glyphicon-link"></span></button>';
        $out .= '</div>';
